...
public class JWERSAOAEPEncryption {
    public static void main(String[] args) throws ParseException, JOSEException {
		 ...
		 * 
		 * // get private key JWK rsaPrivateKey =
		 * JWK.parseFromPEMEncodedObjects(loadRsaPrivateKeyPem());
		 * System.out.println("rsaPrivateKey in JWK format:\n" + rsaPrivateKey);
		 * EncryptedJWT jweDecryptedPayload =
		 * jweRsaDecryptFromBase64UrlToken(rsaPrivateKey, jweTokenBase64Url);
		 * System.out.println("jweDecryptedPayload: " +
		 * jweDecryptedPayload.getJWTClaimsSet());
		 * 
		 * // now you could check the expiration like this:
		 * System.out.println("\nexample for checking token expiration");
		 * printJweExpirationDates(jweDecryptedPayload); // or print the header object
    ...
    private static String loadRsaPublicKeyPem() {
    	...
    	return "-----BEGIN CERTIFICATE-----\n" + 
    			...
    			"DOcOtma3i2Z/N63ffsfwjL4mL8YiXw==\n" + 
    			"-----END CERTIFICATE-----";
    }
}
